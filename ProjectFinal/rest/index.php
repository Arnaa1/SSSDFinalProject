<?php
    ...
    Flight::route('POST /reset', function(){
      ...
      if(empty($error)) {
        ...
        $email->setFrom("ajla.arnautovic@stu.ibu.edu.ba", "Ajla Arnautovic");
        $email->setSubject('Password Renewal');
        $email->addTo($data['email']);
        $email->addContent("text/plain", 'Your password reset link: https://ajlaarnautovic.herokuapp.com/rest/verify/'.$username.'/'.$generatedNumber);
